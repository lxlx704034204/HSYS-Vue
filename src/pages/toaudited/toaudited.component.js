export default {
    ...
    methods: {
        ...
        orderInf() {
            var that = this;
            this.axios.get('order/' + this.orderid + '?t=' + Math.random()).then(function(res) {
                if (typeof res !== 'string') {
                    ...
                    that.axios.get('sys/user/' + that.userid + '?t=' + Math.random())
        ...
        del() {
            ...
            this.axios.post(this.baseURL + 'order/' + this.orderid + '/cancel').then((res) => {
                this.orderInf();
        ...
        confirmReceived() {
            ...
            this.axios.post(this.baseURL + 'order/' + this.orderid + "/receive").then((res) => {
                console.log(res);
