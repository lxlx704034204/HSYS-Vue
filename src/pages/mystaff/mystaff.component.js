export default {
    ...
    methods: {
        ...
        likeSearch() {
            var that = this;
            this.axios.get("user/all?userName=" + that.value + '&t=' + Math.random()).then(function(data) {
        ...
        _mystafftable() {
            var that = this;
            this.axios.get("user/all?current=" + that.pageNum + '&size=6' + '&t=' + Math.random()).then(function(data) {
