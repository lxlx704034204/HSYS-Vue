...
export default {
    ...
    created() {
        ...
        //			.then(function(data) {
        //				that.dd = data[0].dictionaries;
        //				console.log(that.dd, 'dd')
        //			});
        var json2 = {};
        ...
        this.topstyle();
        //  用户产品
        that.axios.get("customerproduct/all?user_id=" + this.userId + '&date='+new Date().getTime())
            .then(function(data) {
    ...
    methods: {
        ...
        custominf() {
            var that = this;
            this.$nextTick(function() {
                this.axios.get("customer/detail/" + this.userId + '?date='+new Date().getTime())
                    .then(function(data) {
                        console.log(data);
        ...
        detailinf() {
            var that = this;
            this.axios.get("customerproduct/info?id=" + this.$route.query.id + '&date='+new Date().getTime(), {
                    params: {
                        noInterceptor: 1
                    }
                })
