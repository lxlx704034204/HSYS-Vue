export default {
    ...
    methods: {
        ...
        changemsg(id) {
            ...
            var that = this;
            this.axios.get("address/init/" + id + '?t=' + Math.random()).then((res) => {
                ...
                var cityObj = {};
                that.axios.get(`area/list?parent=${that.ruleForm.province}` + '&t=' + Math.random()).then((cityList) => {
                ...
                var countryObj = {};
                that.axios.get(`area/list?parent=${that.ruleForm.city}` + '&t=' + Math.random()).then((countryList) => {
